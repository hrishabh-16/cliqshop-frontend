...
export class CheckoutComponent implements OnInit {
  ...
  /**
   * New method to redirect to Stripe Checkout
   */
  redirectToStripeCheckout(orderResponse: any): void {
    ...
    const checkoutRequest = {
      ...
      customerName: `${this.checkoutForm.get('billing')?.get('firstName')?.value} ${this.checkoutForm.get('billing')?.get('lastName')?.value}`,
